...
<div class="vg-search-eb-container">
    ...
    <form class="vg-search-eb mod-vg-search-eb-<?php echo (int) $module->id; ?> vg-search-eb-<?php echo htmlspecialchars($moduleLayout, ENT_QUOTES, 'UTF-8'); ?>">
        <?php if (!empty($itemId)) : ?>
        ...
        <div class="eb-filter-container vg-filter-layout-<?php echo htmlspecialchars($moduleLayout, ENT_QUOTES, 'UTF-8'); ?>">
